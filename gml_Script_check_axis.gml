...
if (argument0 == 6)
{
    if (joystick_pov(global.opjoyid) == 225 || joystick_pov(global.opjoyid) == 270 || joystick_pov(global.opjoyid) == 315)
        return -1;
    
    if (joystick_pov(global.opjoyid) == 45 || joystick_pov(global.opjoyid) == 90 || joystick_pov(global.opjoyid) == 135)
        return 1;
}

if (argument0 == 7)
{
    if (joystick_pov(global.opjoyid) == 0 || joystick_pov(global.opjoyid) == 45 || joystick_pov(global.opjoyid) == 315)
        return -1;
    
    if (joystick_pov(global.opjoyid) == 135 || joystick_pov(global.opjoyid) == 180 || joystick_pov(global.opjoyid) == 225)
        return 1;
}
