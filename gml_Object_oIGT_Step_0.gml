...
if (surface_exists(igt_surface))
{
    ...
    {
        var yoff = 27;
        draw_cool_text(4, yoff, "ping: " + string(global.ping), 0, 16777215, 8421504, 1);
        yoff += 11;
        var metcount = 0;
        ...
        {
            draw_cool_text(4, yoff, "Metroids to A6: " + string(global.MetCount - metcount), 0, 16777215, 8421504, 1);
            yoff += 11;
        }
    ...
    if (oControl.mod_collecteditemsmap == 1)
    {
        ...
        draw_set_alpha(1);
        draw_set_color(c_white);
        draw_cool_text(surface_get_width(igt_surface) - 3, 28, compl + "%", 0, 16777215, 12632256, 1);
        draw_set_halign(fa_left);
    }
