...
switch (type_event)
{
    case 3:
        ...
        switch (msgid)
        {
            ...
            case 110:
                global.showHealthIndicatorsTimer = 900;
                var attackID = buffer_read(_buffer, buffer_u8);
                ...
                else
                {
                    if (instance_exists(oCharacter) && oCharacter.invincible == 0)
                    {
                        with (oCharacter)
                        {
                            ...
                            var cantFreeze = (global.currentsuit == 2 && global.item[5] == 1) || global.currentsuit == 1;
            ...
            case 115:
                ...
                var freezeOff = buffer_read(_buffer, buffer_u8);
            ...
            case 33:
                ...
                var killedBy = buffer_read(_buffer, buffer_u8);
                var deadName = buffer_read(_buffer, buffer_string);
                var killerName = buffer_read(_buffer, buffer_string);
            ...
            case 34:
                var itemString = buffer_read(_buffer, buffer_string);
                ...
                if (global.looting)
                {
                    ...
                    var itemArray = ds_list_find_value(itemList, 0);
