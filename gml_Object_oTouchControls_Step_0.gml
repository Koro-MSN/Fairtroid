...
if (st_pressed[0] == -1)
{
    for (i = 0; i < 5; i += 1)
    {
        if (device_mouse_check_button(i, mb_left))
        {
            var tx = scr_mouse_gui_x(device_mouse_raw_x(i));
            var ty = scr_mouse_gui_y(device_mouse_raw_y(i));
...
{
    var tx = scr_mouse_gui_x(device_mouse_raw_x(jump_pressed[0]));
    var ty = scr_mouse_gui_y(device_mouse_raw_y(jump_pressed[0]));
...
{
    var tx = scr_mouse_gui_x(device_mouse_raw_x(fire_pressed[0]));
    var ty = scr_mouse_gui_y(device_mouse_raw_y(fire_pressed[0]));
...
{
    var tx = scr_mouse_gui_x(device_mouse_raw_x(missile_pressed[0]));
    var ty = scr_mouse_gui_y(device_mouse_raw_y(missile_pressed[0]));
...
{
    var tx = scr_mouse_gui_x(device_mouse_raw_x(morph_pressed[0]));
    var ty = scr_mouse_gui_y(device_mouse_raw_y(morph_pressed[0]));
...
{
    var tx = scr_mouse_gui_x(device_mouse_raw_x(pause_pressed[0]));
    var ty = scr_mouse_gui_y(device_mouse_raw_y(pause_pressed[0]));
...
{
    var tx = scr_mouse_gui_x(device_mouse_raw_x(up_pressed[0]));
    var ty = scr_mouse_gui_y(device_mouse_raw_y(up_pressed[0]));
...
{
    var tx = scr_mouse_gui_x(device_mouse_raw_x(down_pressed[0]));
    var ty = scr_mouse_gui_y(device_mouse_raw_y(down_pressed[0]));
...
if (!global.ingame)
{
    ...
    {
        var tx = scr_mouse_gui_x(device_mouse_raw_x(right_pressed[0]));
        var ty = scr_mouse_gui_y(device_mouse_raw_y(right_pressed[0]));
    ...
    {
        var tx = scr_mouse_gui_x(device_mouse_raw_x(left_pressed[0]));
        var ty = scr_mouse_gui_y(device_mouse_raw_y(left_pressed[0]));
