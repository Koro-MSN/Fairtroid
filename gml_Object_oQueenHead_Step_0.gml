...
var neck_dist = point_distance(neck_base_x, neck_base_y, x, y);
var neck_seglen = neck_dist / neck_segments;
var neck_basedir = point_direction(neck_base_x, neck_base_y, x, y);
