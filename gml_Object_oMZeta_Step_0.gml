...
if (state == 0)
{
    ...
    {
        var msl = instance_nearest(x, y, oMissile);
    ...
    {
        var msl = instance_nearest(x, y, oBeam);
...
if (state == 3)
{
    ...
    if (statetime < 30)
    {
        fleg_frame = anim_frame(587, fleg_frame, 0.5);
        bleg_frame = fleg_frame;
    }
...
if (state == 4)
{
    ...
    if (statetime >= 10)
    {
        fleg_frame = anim_frame(588, fleg_frame, 0.2);
        bleg_frame = fleg_frame;
    }
...
if (state == 6)
{
    ...
    if (statetime < 20)
    {
        fleg_frame = anim_frame(587, fleg_frame, 1);
        bleg_frame = fleg_frame;
    }
    ...
    if (statetime > 10 && statetime < 35)
        farm_frame = anim_frame(585, farm_frame, 0.5);
    ...
    if (statetime > 30 && statetime < 50)
        barm_frame = anim_frame(585, barm_frame, 0.5);
...
if (state == 8)
{
    ...
    if (statetime < 50)
        fleg_frame = anim_frame_cycle(589, fleg_frame, 1);
...
if (state == 9)
{
    ...
    if (statetime > 16)
    {
        ...
        if (floor(fleg_frame) != 8)
            fleg_frame = anim_frame_cycle(589, fleg_frame, 0.5);
        
        if (floor(bleg_frame) != 18)
            bleg_frame = anim_frame_cycle(579, bleg_frame, 0.25);
    }
...
if (state == 50)
{
    ...
    if (statetime > 70)
    {
        fleg_frame = anim_frame(587, fleg_frame, -0.25);
        bleg_frame = fleg_frame;
    }
    ...
    if (statetime > 100)
        body_frame = anim_frame(580, body_frame, -0.2);
