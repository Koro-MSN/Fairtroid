...
with (oFXAnimSpark)
{
    ...
    {
        var lum = (1 - ((image_index / 11) * 220)) + 35;
...
with (oA8RedLight)
{
    var col = make_color_rgb(image_alpha * 255, 0, 0);
...
with (oA6Dust)
{
    var col = make_color_rgb(image_alpha * 133, image_alpha * 189, image_alpha * 136);
...
{
    var col = make_color_rgb(0, image_alpha * 255, 0);
...
with (oCoreX)
{
    if (sprite_index == sCoreXGenesis)
    {
        ...
        var col = make_color_rgb(purple_glow * 255, purple_glow * 109, purple_glow * 245);
