...
if (global.joydetected && global.openablejoy && !gamepad_is_connected(global.gamepadIndex))
{
    ...
    {
        if (ctrl_Left == 0 && ctrl_Right == 0 && joystick_check_button(global.opjoyid, global.opjoybtn_padl))
        {
            ctrl_Left = 1;
            global.controltype = 1;
            walk_zone = 0;
        ...
        if (ctrl_Left == 0 && ctrl_Right == 0 && joystick_check_button(global.opjoyid, global.opjoybtn_padr))
        {
            ctrl_Right = 1;
            global.controltype = 1;
            walk_zone = 0;
        ...
        if (ctrl_Up == 0 && ctrl_Down == 0 && joystick_check_button(global.opjoyid, global.opjoybtn_padu))
        {
            ctrl_Up = 1;
            global.controltype = 1;
            walk_zone = 0;
        ...
        if (ctrl_Up == 0 && ctrl_Down == 0 && joystick_check_button(global.opjoyid, global.opjoybtn_padd))
        {
            ctrl_Down = 1;
            global.controltype = 1;
            walk_zone = 0;
