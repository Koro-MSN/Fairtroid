...
if (global.opxjoyvib && sfx_isplaying(243) && global.ingame)
    immersion_play_effect(111);

if (!global.ingame || room == rm_transition)
    immersion_stop();

if (instance_exists(oTouchControls) && (global.joydetected == 0 || global.ingame == 0))
{
    ...
    if (oTouchControls.aimupleft_pressed[0] != -1)
    {
        ...
        {
            if (oCharacter.state != oCharacter.BALL && oCharacter.state != oCharacter.AIRBALL && oCharacter.state != oCharacter.SPIDERBALL && oCharacter.state != oCharacter.GRABBEDQUEENMORPH && oCharacter.state != oCharacter.GRABBEDQUEENBELLY)
                ctrl_Left = 1;
        }
...
if (gamepad_is_supported())
{
    if (gamepad_is_connected(global.opjoyid) && global.joydetected && !global.compatibilitymode)
    {
        ...
        if (ctrl_Left == 0 && ctrl_Right == 0 && gamepad_button_check(global.opjoyid, gp_padl))
        {
            ctrl_Left = 1;
            global.controltype = 2;
            walk_zone = 0;
        ...
        if (ctrl_Left == 0 && ctrl_Right == 0 && gamepad_button_check(global.opjoyid, gp_padr))
        {
            ctrl_Right = 1;
            global.controltype = 2;
            walk_zone = 0;
        ...
        if (ctrl_Up == 0 && ctrl_Down == 0 && gamepad_button_check(global.opjoyid, gp_padu))
        {
            ctrl_Up = 1;
            global.controltype = 2;
            walk_zone = 0;
        ...
        if (ctrl_Up == 0 && ctrl_Down == 0 && gamepad_button_check(global.opjoyid, gp_padd))
        {
            ctrl_Down = 1;
            global.controltype = 2;
            walk_zone = 0;
        ...
        if ((ctrl_A == 0 && gamepad_button_check(global.opjoyid, global.opxjoybtn_a)) || (global.opxjoybtn_a == 32777 && keyboard_check(vk_backspace)))
        {
            ctrl_A = 1;
            global.controltype = 2;
        }
        
        if ((ctrl_B == 0 && gamepad_button_check(global.opjoyid, global.opxjoybtn_b)) || (global.opxjoybtn_b == 32777 && keyboard_check(vk_backspace)))
        {
            ctrl_B = 1;
            global.controltype = 2;
        }
        
        if ((ctrl_X == 0 && gamepad_button_check(global.opjoyid, global.opxjoybtn_x)) || (global.opxjoybtn_x == 32777 && keyboard_check(vk_backspace)))
        {
            ctrl_X = 1;
            global.controltype = 2;
        }
        
        if ((ctrl_L == 0 && gamepad_button_check(global.opjoyid, global.opxjoybtn_l)) || (global.opxjoybtn_l == 32777 && keyboard_check(vk_backspace)))
        {
            ctrl_L = 1;
            global.controltype = 2;
        }
        
        if ((global.opaimstyle == 1 && ctrl_L2 == 0 && gamepad_button_check(global.opjoyid, global.opxjoybtn_l2)) || (global.opxjoybtn_l2 == 32777 && keyboard_check(vk_backspace)))
        {
            ctrl_L2 = 1;
            global.controltype = 2;
        }
        
        if ((ctrl_R == 0 && gamepad_button_check(global.opjoyid, global.opxjoybtn_r)) || (global.opxjoybtn_r == 32777 && keyboard_check(vk_backspace)))
        {
            ctrl_R = 1;
            global.controltype = 2;
        }
        
        if ((ctrl_R2 == 0 && gamepad_button_check(global.opjoyid, global.opxjoybtn_r2)) || (global.opxjoybtn_r2 == 32777 && keyboard_check(vk_backspace)))
        {
            ctrl_R2 = 1;
            global.controltype = 2;
        }
        
        if ((ctrl_Select == 0 && gamepad_button_check(global.opjoyid, global.opxjoybtn_sel)) || (global.opxjoybtn_sel == 32777 && keyboard_check(vk_backspace)))
        {
            ctrl_Select = 1;
            global.controltype = 2;
        }
        
        if ((ctrl_Start == 0 && gamepad_button_check(global.opjoyid, global.opxjoybtn_str)) || (global.opxjoybtn_str == 32777 && keyboard_check(vk_backspace)))
        {
            ctrl_Start = 1;
            global.controltype = 2;
        }
        
        if ((ctrl_Exit == 0 && gamepad_button_check(global.opjoyid, global.opxjoybtn_exit)) || (global.opxjoybtn_exit == 32777 && keyboard_check(vk_backspace)))
        {
            ctrl_Exit = 1;
            global.controltype = 2;
        }
        
        if ((ctrl_Menu1 == 0 && gamepad_button_check(global.opjoyid, global.opxjoybtn_menu1)) || (global.opxjoybtn_menu1 == 32777 && keyboard_check(vk_backspace)))
        {
            ctrl_Menu1 = 1;
            global.controltype = 2;
        }
        
        if ((ctrl_Menu2 == 0 && gamepad_button_check(global.opjoyid, global.opxjoybtn_menu2)) || (global.opxjoybtn_menu2 == 32777 && keyboard_check(vk_backspace)))
        {
            ctrl_Menu2 = 1;
            global.controltype = 2;
        }
...
if (gamepad_is_supported())
{
    if (gamepad_is_connected(global.opjoyid) && global.joydetected && global.compatibilitymode)
    {
        ...
        else if (global.opanalog_invert == 0)
        {
