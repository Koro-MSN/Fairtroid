...
while (1)
{
    ...
    if ((shuff == 0 || shuff == 2 || shuff == 3 || shuff == 4 || shuff == 6 || shuff == 7) && (oControl.mod_111 == 0 || oControl.mod_111 == 2 || oControl.mod_111 == 3 || oControl.mod_111 == 4 || oControl.mod_111 == 6 || oControl.mod_111 == 7))
    {
    }
    else
    {
